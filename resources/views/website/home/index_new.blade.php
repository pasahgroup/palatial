...
<head>
    ...
    <!-- Favicon -->
    <link href="../../custom/img/favicon.ico" rel="icon">
...
<!--     <div id="spinner" class="show bg-white position-fixed translate-middle w-100 vh-100 top-50 start-50 d-flex align-items-center justify-content-center">
        ...
        <img class="position-absolute top-50 start-50 translate-middle" src="../../custom/img/icons/icon-1.png" alt="Icon">
    </div> -->
    <!-- Spinner End -->
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
        <a href="index.html" class="navbar-brand ms-4 ms-lg-0">
            <h1 class="text-primary m-0"><img class="me-3" src="../../assets/corporate/img/logos/logo-corp-red.png" style="height:7vh; width: 170%" alt="Palatial tours"></h1>
        </a>
...
@endforeach
            ...
            <div class="owl-carousel-item position-relative" data-dot="<img src='../custom/img/carousel-3.jpg'>">
                <img class="img-fluid" src="../custom/img/carousel-3.jpg" alt="">
                <div class="owl-carousel-inner">
                    <div class="container">
                        <div class="row justify-content-start">
                            <div class="col-10 col-lg-8">
                                 <h3 class="text-white">wawa pgn</h3>
                                <p class="fs-5 fw-medium text-white mb-4 pb-3">Vero elitr justo clita lorem. Ipsum dolor at sed stet sit diam no. Kasd rebum ipsum et diam justo clita et kasd rebum sea elitr.</p>
                                <a href="" class="py-1 px-5 animated slideInLeft">Read More >></a>
                            </div>
                        </div>
                    </div>
                </div>
 ...
 @endisset
    ...
    <!-- Carousel End -->
<!-- btn btn-primary py-2 px-4 d-none d-lg-block -->
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                    ...
                    <a class="btn btn-primary py-2 px-4 d-none d-lg-block" href="">Read More</a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="tab-content w-100">
                            ...
                            <div class="row g-4">
                                <div class="col-md-6" style="min-height: 350px;">
                                    <div class="position-relative h-100">
                                        <img class="position-absolute img-fluid w-100 h-100" src="../custom/img/project-1.jpg"
                        ...
                        <div class="tab-pane fade" id="tab-pane-2">
                            <div class="row g-4">
                                <div class="col-md-6" style="min-height: 350px;">
                                    <div class="position-relative h-100">
                                        <img class="position-absolute img-fluid w-100 h-100" src="../custom/img/project-2.jpg"
                                            style="object-fit: cover;" alt="">
                                    </div>
                                </div>
                                <div class="col-md-6">
                        ...
                        <div class="tab-pane fade" id="tab-pane-3">
                            <div class="row g-4">
                                <div class="col-md-6" style="min-height: 350px;">
                                    <div class="position-relative h-100">
                                        <img class="position-absolute img-fluid w-100 h-100" src="../custom/img/project-3.jpg"
                                            style="object-fit: cover;" alt="">
                                    </div>
                                </div>
                                <div class="col-md-6">
