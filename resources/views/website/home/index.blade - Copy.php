...
@section('content')
  ...
  @foreach ($sliders as $slides)
        <div class="slider-item js-fullheight">        
            <div class="container-fluid p-0">
                   ...
                   <img class="one-third order-md-last img-fluid" src="{{URL::asset('/storage/uploads/'.$slides->attachment)}}" alt="" style="">
                  ...
                  <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
                    <div class="text">
                        ...
                        <div class="horizontal">
                            ...
                            <p class="mb-4 demo-1s">{{ $slides->description }}</p>
  ...
  <div class="slider-item">        
            <div class="container-fluid p-0">
                   ...
                   <img class="one-third order-md-last img-fluid" src="{{URL::asset('/storage/uploads/'.$quickSliderf->attachment)}}" alt="" style="height:10%">
              <div class="row d-flex no-gutters slider-text align-items-center justify-content-end" data-scrollax-parent="true">
