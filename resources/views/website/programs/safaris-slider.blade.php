    ...
    <div class="container">
          <!-- Start of Image filled from slider -->
             <div class="package-list-wrap ">
                 <img src="{{URL::asset('/storage/uploads/'.$sliders->attachment) }}" class="" alt="det-img" style="min-height: 50vh !important;max-height:50vh !important;background-size:100% 100%;width: 100%;">
