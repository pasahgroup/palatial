          ...
          <div class="col-md-12">
            <div class="card card-outline card-info">
              ...
              <div class="container-fluid x_content">
                <br />
                {{$datas->full_name}}
              <form  method="post" id="post_form" action="{{ route('TestimonyUpdate',$datas->id) }}" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                @csrf
                <input type="hidden" name="user_id" value="{{ Auth::id() }}">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-8 col-md-8">
                        <input type="text" class="form-control" name="full_name" value="{{$datas->full_name}}">
                      </div>
                        </div>
                    </div>
                  ...
                  <div class="col-md-12 col-sm-6 col-xs-12">
                      <label class="control-label" for="first-name">Comments
                       ...
                       <textarea name="comments"  class="form-control" max="180">{{$datas->comments}}</textarea>
                  </div>
                <br>
