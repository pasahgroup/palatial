        ...
        <div class="card-body">
            <div class="card-body">
                <div class="card">
                    ...
                    <div class="card-body">
                      <h4 class="card-title">{{ $programs->Addon_name }}</h4>
                      <p class="card-text">
                    ...
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                          ...
                          <p class="">
                              <span class=""> Accommodation: </span>{{ $data->accommodation_name }} </p>

                            <p class=""><span class=""> Destination: </span>{{ $data->destination_name }} </p>
