          ...
          <div class="col-md-12">
            <div class="card card-outline card-info">
              ...
              <div class="container-fluid x_content">
                <br />
              <form  method="post" id="post_form" action="{{ route('socialMedia-update',$id) }}" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                @csrf
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-8 col-md-8">
                              <input type="text" name="social_name" class="form-control"  value="{{$socialmedia->social_name}}">
                            </div>
                              </div>
                          </div>                                                 
                        </div>
