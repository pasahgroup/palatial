                ...
                <div class="listing-badge now-open"><strong><?php echo e(round($special_private->save/$special_private->price * 100),0); ?>% Off</strong></div>
                    ...
                    <div class="product-img position-relative overflow-hidden">
                        ...
                        <div class="product-action">
                            <a class="btn btn-outline-dark btn-squarex" href="<?php echo e(route('safaris.show',$special_private->tour_id,$offers)); ?>"><i class="fa fa-search">  <?php echo e($special_private->tour_name); ?></i></a>
                        </div>
                    </div>
                               ...
                               <div class="single_blog listing-shot">
                                               ...
                                               <div class="listing-badge now-open"><strong><?php echo e(round($special_group->save/$special_group->price * 100),0); ?>% Off</strong></div>
                                                   ...
                                                   <div class="product-img position-relative overflow-hidden">
                                                       ...
                                                       <div class="product-action">
                                                           <a class="btn btn-outline-dark btn-squarex" href="<?php echo e(route('grouptour.show',$special_group->tour_id,$offers)); ?>"><i class="fa fa-search">  <?php echo e($special_group->tour_name); ?></i></a>
                                                       </div>
                                                   </div>
...
<?php echo $__env->make('website.layouts.apps', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/drongosa/palatialtours.com/resources/views/website/home/index.blade.php ENDPATH**/ ?>