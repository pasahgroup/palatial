     ...
     <hr>
       ...
       <div class="col-lg-4 col-md-4 col-sm-4">
                                   <label for=""><?php echo e($media->social_name); ?>
                                    ...
                                    <div class="form-group">
                                       <input id="facebook" type="checkbox"  name="hear[]" value="<?php echo e($media->social_name); ?>"></label>
                                    </div>
                                </div>
...
<?php echo $__env->make('website.layouts.apps', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\palatialf\resources\views/website/agents/partner.blade.php ENDPATH**/ ?>