                            ...
                            <div class="row">
                                 ...
                                 <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12 text-right booking-btn-gray">
                                                                                <a href="<?php echo e(route('safaris.show',$special_private->tour_id)); ?>" class="btn booking-btn"><b>View Details</b></a>
                                    </div>   
                                </div>
     ...
     <h4><b style="background:"><?php echo e($special_group->sales_header); ?></b></h4>
                        <div class="single_blog listing-shot">                         
                            ...
                            <div class="row">
                              ...
                              <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12 text-right booking-btn-gray">
                                                                                 <a href="<?php echo e(route('grouptour.show',$special_group->tour_id)); ?>" class="btn booking-btn"><b>Explore Tour Details</b></a>
                                    </div>  
                                      </div>                          
                                </div>
