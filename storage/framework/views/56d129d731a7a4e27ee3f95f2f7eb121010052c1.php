    ...
    <?php $__currentLoopData = $datas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
     <?php if($data->type=='Basic'): ?>
      ...
      <div class="card-header booking-tourPadding">
                                                <h5 class="m-0"><b><?php echo e($data->category); ?>: <?php echo e($data->accommodation_name); ?> </b></h5>                                              
                                                </div>
                       ...
                       <div class="row">
                               ...
                               <div class="row">                   
                                <div class="col-md-6 col-lg-6 col-sm-12">                                   
                                  ...
                                  <a class="map-viw" href="#"><i class="fa fa-map-marker"></i> <?php echo e($data->location_name); ?></a> 
                                ...
                                <a class="map-viw" href="#"><i class="fa fa-home"></i><b><?php echo e($data->accommodation_name); ?></b> | From <b style="color:blue">$ <?php echo e(number_format($data->price,2)); ?></b></a>      
                                    ...
                                    <div class="col-lg-3">                           
                                            <div class="hotel-pics-one">                                                
                                                  ...
                                                  <a href="https://<?php echo e($data->url); ?>" class="btn btn-primary float-right" role="button">View More</a>                                                 
                                    </div>
      ...
      <?php $__currentLoopData = $datas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
     <?php if($data->type=='Comfort'): ?>
       <div class="card">   
      <div class="card-header booking-tourPadding">
                                                <h5 class="m-0"><b><?php echo e($data->accommodation_name); ?>: <?php echo e($data->accommodation_name); ?></b></h5>                                              
                                                </div>
                                    ...
                                    <div>                            
                                     <a class="map-viw" href="#"><i class="fa fa-home"></i><b>Standard Category:   
                                       ...
                                       <a class="map-viw" href="#"><i class="fa fa-home"></i><b>Our Category</b>: <?php echo e($data->type); ?>:</a>
                                        ...
                                        <div class="col-lg-3">                          
                                         <div class="hotel-pics-one">                                               
                                            <img src="<?php echo e(URL::asset('/storage/uploads/'.$data->attachment)); ?>" alt="" style="height: 32vh !important;width:100%">                                                                      </div>
                                                <a href="https://<?php echo e($data->url); ?>" class="btn btn-primary" role="button">View More</a>
      ...
      <div class="card-header booking-tourPadding">
                       ...
                       <div class="row ">
                               ...
                               <div class="row">                   
                                ...
                                <div class="col-md-6 col-lg-6 col-sm-12">                              
                                <div class="rating">                                                                         <h4>Accommodation Details</h4>                                                                       </div>  <a class="map-viw" href="#"><i class="fa fa-home"></i><b><?php echo e($data->accommodation_name); ?></b> | From <b style="color:blue">$ <?php echo e(number_format($data->price,2)); ?></b></a>      
...
<?php echo $__env->make('website.layouts.apps', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\palatialf\resources\views/website/accommodation/accommodationList.blade.php ENDPATH**/ ?>