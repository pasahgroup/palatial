    ...
    <div class="container">
          <!-- Start of Image filled from slider -->
             <div class="package-list-wrap ">
                 <img src="<?php echo e(URL::asset('/storage/uploads/'.$sliders->attachment)); ?>" class="" alt="det-img" style="min-height: 35vh !important;max-height:50vh !important;background-size:100% 100%;width: 100%;">
    ...
    <div class=""> 
      ...
      <!-- End of Image filled from slider -->
        ...
        <div class="masonry-item">
         ...
         <h3 style="color:#b76b0b;" class="">More: <?php echo e($title); ?></b></h3>
                    </div>
            </div>
        </div>
            <!-- item -->
            ...
            <?php $__currentLoopData = $safaris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $safari): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                 <div class="col-lg-4 col-md-4">
                        <div class="single_blog listing-shot">                         
                                ...
                                <div class="">
                                 <h3 class="text-center demo-1"> <b style="color:"><?php echo e($safari->tour_name); ?></b>
                                    </h3>
                                </div>
