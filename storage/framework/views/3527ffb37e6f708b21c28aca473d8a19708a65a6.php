         ...
         <div class="align-items-center py-1 px-xl-5 d-lg-flex" style="border:1px solid rgba(0,0,0,.9);background:#dfd78e;">
              <div class="col-lg-3 col-md-4">
                <a href="" class="text-decoration-none">
                    <span class="h4 text-uppercase text-primary bg-dark px-1">PALATIAL</span>
                    <span class="h4 text-uppercase text-dark bg-primary px-1 ml-n1">Tour</span>
                </a>
...
<?php /**PATH /home/drongosa/palatialtours.com/resources/views/website/layouts/header3.blade.php ENDPATH**/ ?>