                 ...
                 <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    <div class="form-group">                      
                      <div class="col-sm-8 col-md-8"><label for="title" class="">Message Title</label>
                         <select name="title" id="" class="form-control">
                                          <option><?php echo e($titles->title); ?></option>
                  ...
                  <div class="col-md-12 col-sm-6 col-xs-12">
                      <label class="control-label" for="post_body">Message Body/Description
                       ...
                       <textarea name="post_body" class="form-control" maxlength="1000"><?php echo e($titles->body); ?></textarea>
...
<?php echo $__env->make('admins.layouts.Apps.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\palatialf\resources\views/admins/titles/editTitle.blade.php ENDPATH**/ ?>