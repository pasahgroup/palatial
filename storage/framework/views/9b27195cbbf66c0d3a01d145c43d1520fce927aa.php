          ...
          <table class="table table-responsive cart-checkout-table">
            ...
            <tbody>
              <tr>
                ...
                <td>100%</td>
                <td><?php echo e(number_format($cust->adults_cost,2)); ?> <?php echo e($cust->currency); ?></td>
                <td class="text-center">
                  <?php echo e($cust->adults); ?>
              ...
              <tr>
                ...
                <td>Lorem ipsum dolor sit amet, consectetur.</td>
                <td>40%</td>
                <td><?php echo e(number_format($cust->teens_cost,2)); ?> <?php echo e($cust->currency); ?></td>
                <td class="text-center">
                  <?php echo e($cust->teens); ?>
               ...
               <tr>
                ...
                <td>Lorem ipsum dolor sit amet, consectetur.</td>
                <td>75%</td>
                <td><?php echo e(number_format($cust->children_cost,2)); ?> <?php echo e($cust->currency); ?></td>
                <td class="text-center">
                  <?php echo e($cust->children); ?>
