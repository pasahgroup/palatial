            ...
            <div class="row">
                <div class="col-12">
                    <div class="advanced-search-form bg-color">
                        ...
                        <!-- Search Form -->
                         <form  method="post"  action="<?php echo e(route('tailorMade.store')); ?>">
                             <?php echo csrf_field(); ?>
                            <div class="row">
...
<?php echo $__env->make('website.layouts.apps', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\palatialf\resources\views/website/tailorMade/tailorEnquiryForm.blade.php ENDPATH**/ ?>