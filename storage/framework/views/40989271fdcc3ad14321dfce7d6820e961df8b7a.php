          ...
          <div class="col-md-12">
            <div class="card card-outline card-info">
              ...
              <div class="container-fluid x_content">
                <br />
               <form  method="POST" id="post_form" action="<?php echo e(route('PostBody.update',$postbody->id)); ?>" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
                <?php echo csrf_field(); ?>
                ...
                <div class="row" id="title">
                    ...
                    <div class="form-group">                      
                      <div class="col-sm-8 col-md-8"><label for="title" class="">Message Type</label>
                         <select name="post_category" id="post_category" class="form-control">
                                          <option><?php echo e($postbody->category_aboutus); ?></option>
                    ...
                    <div class="form-group">                      
                      <div class="col-sm-6 col-md-6"><label for="post_category" class="">Message Title </label>
                        <input type="text" class="form-control" name="title"  value="<?php echo e($postbody->title); ?>">
                      </div>
                        </div>
                    </div>
                    </div>
                  ...
                  <div class="col-md-12 col-sm-6 col-xs-12">
                      <label class="control-label" for="post_body">Message Body/Description
                       ...
                       <textarea name="post_body" class="form-control" maxlength="1000"><?php echo e($postbody->body); ?></textarea>
...
<?php endif; ?>
            ...
            <span class="img-div">
              ...
              <img src="<?php echo e(URL::asset('/storage/uploads/'.$postbody->attachment)); ?>" onClick="triggerClick()" id="profileDisplay">
            </span>
            </div>

               <div class="col-md-4 col-sm-4 col-xs-12">
                      <select name="status" id="status" class="form-control">
                         <option><?php echo e($postbody->status); ?></option>
...
<?php echo $__env->make('admins.layouts.Apps.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\palatialf\resources\views/admins/coa/editAboutus.blade.php ENDPATH**/ ?>