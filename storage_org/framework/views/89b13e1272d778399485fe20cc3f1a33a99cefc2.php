          ...
          <div class="col-md-12">
            <div class="card card-outline card-info">
              <div class="card-header">
                <h3 class="card-title">
                    <?php if($day_data->tour_addon=="Programs"): ?>
                 <a href="<?php echo e(route('programs.show',$day_data->program_id)); ?>"class="btn btn-primary"><span class="fa fa-arrow-left"></span> Back</a>
                 <?php endif; ?>
                 <?php if($day_data->tour_addon=="tailor_made"): ?>
                   <a href="<?php echo e(route('attachmentTailorMade',$day_data->program_id)); ?>"class="btn btn-primary"><span class="fa fa-arrow-left"></span> Back</a>
                    <?php endif; ?>
                </h3>
              </div>
